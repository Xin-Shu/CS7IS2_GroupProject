...
def solve(grid, index, total):
    ...
    AC3_result, sudokuSol = AC3(sudoku)

    print("sudokuSol", list(sudoku.binary_constraints))
    while list(sudoku.binary_constraints) is not None:
        i = list(sudoku.binary_constraints).pop(0)
        print(i)
